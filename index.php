...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="speakers">
			...
			<h1>Speakers</h1>
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 speaker-div">
				<a href="<?php echo ChangeMaker::$domain; ?>programa/actividad/11">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 speaker-div">
				<a href="<?php echo ChangeMaker::$domain; ?>programa/actividad/14">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 speaker-div">
				<a href="<?php echo ChangeMaker::$domain; ?>programa/actividad/5">
					<img class="speaker" src="<?php echo ChangeMaker::$domain; ?>assets/img/sabina.png"/>
				</a>
		...
		<div id="sponsors">
			...
			<div id="sponsors-logos">
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-4 col-md-4 col-lg-3"><img src="<?php echo ChangeMaker::$domain; ?>assets/img/sponsors/unreasonable.png"/></div>
					<div class="col-xs-6 col-sm-4 col-md-4 col-lg-3"><img src="<?php echo ChangeMaker::$domain; ?>assets/img/sponsors/ecotlan.jpg"/></div>
					<div class="col-xs-6 col-sm-4 col-md-4 col-lg-3"><img src="<?php echo ChangeMaker::$domain; ?>assets/img/sponsors/floresse.png"/></div>
					<div class="col-xs-6 col-sm-4 col-md-4 col-lg-3"><img src="<?php echo ChangeMaker::$domain; ?>assets/img/sponsors/resis.jpg"/></div>
				</div>
			</div>
